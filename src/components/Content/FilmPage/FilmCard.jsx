...
const FilmCard = ({ currentFilm }) => {
  ...
  return (
    <div
      className='p-5 mx-5 flex flex-col justify-center items-center xl:flex-row xl:items-start bg-int-gray-secondary text-int-white-main rounded-lg mb-5 gap-8'>
      <div className='w-full md:w-[45%] lg:w-[38%] px-2'>
        <img
          src={image_url}
          alt='poster'
