  ...
  return (
    <div className='fixed z-10 inset-0 overflow-hidden backdrop-brightness-[0.4]'>
      <Formik
        ...
        onSubmit={(values) => {
          const newReview = {
            user_name: profileData.displayName,
      ...
      >
        <div className='flex justify-center items-center min-h-screen'>
          <Form className='flex flex-col justify-center items-center text-int-white-main'>
            <div className='bg-int-gray-secondary rounded-lg shadow-lg max-w-[20rem] sm:w-[28rem] sm:max-w-none'>
              ...
              <div className='flex flex-col-reverse px-4 pb-3 sm:px-4 sm:flex sm:flex-row-reverse sm:justify-start'>
                <button
                  type='button'
